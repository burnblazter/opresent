<?php
// \app\Views\ketidakhadiran\form-pengajuan.php
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control <?= validation_show_error('deskripsi') ? 'is-invalid' : '' ?>"
                  name="deskripsi" rows="8" placeholder="Deskripsi Ketidakhadiran"><?= old('deskripsi') ?></textarea>
            ...
            <div class="card-body">
              <div class="mb-3">
                ...
                <input class="form-control <?= validation_show_error('tanggal_mulai') ? 'is-invalid' : '' ?>"
                  type="date" name="tanggal_mulai" id="tanggal_mulai" value="<?= old('tanggal_mulai') ?>">
              ...
              <div class="mb-3">
                ...
                <input class="form-control <?= validation_show_error('tanggal_berakhir') ? 'is-invalid' : '' ?>"
                  type="date" name="tanggal_berakhir" id="tanggal_berakhir" value="<?= old('tanggal_berakhir') ?>">
      ...
      <div class="modal-body">
        <ul>
          ...
          <ul>
            ...
            <li class="lh-lg"><strong>Status Approval</strong>: Memerlukan persetujuan dari atasan.</li>
          </ul>
          <p style="font-size: larger;" class="mb-1 text-primary"><strong>Sakit</strong></p>
          <ul>
            <li class="lh-lg"><strong>Pengajuan</strong>: Hanya dapat diajukan pada hari ini atau hari esok.</li>
