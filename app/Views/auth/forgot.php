  ...
  <div class="page page-center">
    <div class="container container-tight py-4">
      ...
      <div class="card card-md">
        <div class="card-body">
          <h2 class="card-title text-center mb-3"><?= lang('Auth.forgotPassword') ?></h2>
          ...
          <form action="<?= url_to('forgot') ?>" method="post" autocomplete="off">
            <?= csrf_field() ?>
            <div class="mb-3">
          ...
          <div class="text-center mt-3">
            <a href="<?= base_url('login') ?>" class="text-muted">Kembali ke halaman login</a>
          </div>
        </div>
      </div>
    </div>
