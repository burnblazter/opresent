      ...
      <div class="d-flex">
        ...
        <div>
          ...
          <div class="text-secondary">
            Pengajuan hanya dapat dimanage untuk hari ini dan tanggal sebelumnya. Pengajuan setelah tanggal mulai
            bersifat
            read-only.
          </div>
        </div>
                        ...
                        <div class="row g-1 justify-content-evenly w-100">
                          <div class="col-md-12">
                            <select name="status" id="status" class="form-select">
                              ...
                              <option value="APPROVED" <?= ($filter_status == 'APPROVED') ? 'selected' : '' ?>>APRROVED
                              </option>
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <?php else : ?>
                    <a href="<?= base_url('/kelola-ketidakhadiran/' . $data->id) ?>"
                      class="d-inline-flex align-items-center badge <?php if ($data->status_pengajuan === 'PENDING') {
                                                                                                                                                                        echo 'badge-outline text-yellow';
                                                                                                                                                                    } else if ($data->status_pengajuan === 'REJECTED') {
                                                                                                                                                                        echo 'badge-outline text-red';
                                                                                                                                                                    } else {
...
$(document).ready(function() {
  $('#keyword').on('keyup', function() {
    $.get('cari-data-ketidakhadiran?keyword=' + $('#keyword').val() + '&bulan=' + $('#bulan').val() +
      '&tahun=' + $('#tahun').val() + '&tipe=' + $('#tipe').val() + '&status=' + $('#status').val(),
      function(data) {
