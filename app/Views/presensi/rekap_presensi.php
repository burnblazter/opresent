<?php
// \app\Views\presensi\rekap_presensi.php
                ...
                <div class="col">
                  <div class="row g-1">
                    <div class="col">
                      ...
                      <input type="date" name="tanggal_dari" class="form-control" id="tanggal_dari"
                        value="<?= $tanggal_dari ?>">
                    </div>
                    <div class="col">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td class="text-center"><a
                      href="<?= base_url('assets/img/foto_presensi/masuk/' . $data_presensi->foto_masuk) ?>"
                  ...
                  <?php else : ?>
                  <td class="text-center"><a
                      href="<?= base_url('assets/img/foto_presensi/keluar/' . $data_presensi->foto_keluar) ?>"
                      target="_blank">Lihat Foto</a></td>
                  <?php endif; ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Export Rekap Presensi Pengguna</h5>
      ...
      <form action="<?= base_url('/rekap-presensi/excel') ?>" method="POST">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input class="form-control mt-1" type="date" id="tanggal_awal" name="tanggal_awal"
              value="<?= $tanggal_dari ?>">
          </div>
          <div class="mb-3">
            <label for="tanggal_akhir">Tanggal Akhir</label>
            <input class="form-control mt-1" type="date" id="tanggal_akhir" name="tanggal_akhir"
              value="<?= $tanggal_sampai ?>">
          </div>
        </div>
