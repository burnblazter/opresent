        ...
        <div class="row g-3 justify-content-between">
          <div class="col-lg-6 col-md-12">
            <div class="input-icon">
              ...
              <input type="text" value="<?= $keyword ?>" id="keyword" class="form-control" placeholder="Temukan Unit..."
                autofocus>
            </div>
          </div>
              ...
              <div class="row g-1">
                <div class="col">
                  <input type="text" id="tambah-jabatan" name="jabatan"
                    class="form-control <?= validation_show_error('jabatan') ? 'is-invalid' : '' ?>"
                    placeholder="Tambah Unit Baru" autocomplete="off" value="<?= old('jabatan') ?>">
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                <tr class="text-center">
                  ...
                  <th>Nama Unit</th>
                  <th style="min-width: 150px; width: 150px;">Total user</th>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <a href="#" class="badge bg-danger btn-hapus" data-bs-toggle="modal" data-bs-target="#modal-danger"
                      data-id="<?= $jabatan->id ?>" data-name="<?= $jabatan->jabatan ?>">
                      Hapus
                    </a>
                  </td>
                </tr>
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center py-4">
        ...
        <h3>Hapus?</h3>
        <div class="text-muted">Apakah Anda yakin ingin menghapus unit <strong><span id="modal-name"
              class="text-danger">ini</span></strong>? Unit yang sudah dihapus tidak dapat dikembalikan.</div>
      </div>
