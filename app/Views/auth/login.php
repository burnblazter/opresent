          ...
          <form action="<?= url_to('login') ?>" method="post" autocomplete="off" novalidate>
            ...
            <div class="mb-3">
              ...
              <input name="login" type="email"
                ...
                placeholder="<?= lang('Auth.email') ?>" autocomplete="off">
            ...
            <div class="mb-2">
              <label class="form-check">
                <input name="remember" type="checkbox" class="form-check-input" <?php if (old('remember')) : ?> checked
                  <?php endif ?> />
