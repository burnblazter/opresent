    ...
    <div class="row g-3">
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="d-flex">
            <a href="<?= base_url('/logout') ?>" class="card-btn text-danger" data-bs-toggle="modal"
              data-bs-target="#logout-modal">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-logout me-2 text-danger"
            ...
            <a href="<?= base_url('/profile/edit') ?>" class="card-btn">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user-edit me-2 text-muted"
                width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div class="table-responsive">
              <table class="table">
                <tr>
                  ...
                  <td><?= $user_profile->nomor_induk ?></td>
                </tr>
                <tr>
                  <th>Username</th>
                ...
                <tr>
                  ...
                  <td><?php if ($user_profile->active == 0) : ?>
                    ...
                    <span class="text-danger">Belum Aktivasi <a
                        href="<?= base_url('resend-activate-account?login=' . $data_pegawai->email) ?>"
        ...
        <div class="card mt-3">
          ...
          <div class="d-flex">
            <a href="" class="card-btn text-warning" data-bs-toggle="modal" data-bs-target="#password-modal">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-password-user me-2" width="24"
            ...
            <a href="" class="card-btn text-primary" data-bs-toggle="modal" data-bs-target="#email-modal">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mail-cog me-2" width="24"
                height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center py-4">
        ...
        <div class="text-muted">Lanjutkan untuk melindungi informasi pribadi Anda dengan sandi yang baru. <br><br>Kami
          akan mengirimkan token konfirmasi ke alamat email Anda untuk menyelesaikan proses reset password.</div>
      </div>
      <div class="modal-footer">
        <div class="w-100">
          <div class="row">
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center py-4">
        ...
        <div class="text-muted">Lanjutkan untuk memperbarui email Anda dengan yang terbaru. <br><br>Kami akan
          mengirimkan token konfirmasi ke alamat email Anda untuk menyelesaikan proses perubahan alamat email.</div>
      </div>
      <div class="modal-footer">
        <div class="w-100">
          <div class="row">
