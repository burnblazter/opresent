<?php
// \app\Views\data_pegawai\tambah.php
            ...
            <div class="card-body">
              <div class="mb-3 w-100">
                ...
                <input name="nomor_induk" type="text"
                  ...
                  placeholder="e.g. 2024001 atau 199001012020121001" value="<?= old('nomor_induk') ?>">
                <?php if (validation_show_error('nomor_induk')) : ?>
              ...
              <div class="mb-3 w-100">
                ...
                <input name="nama" type="text"
                  ...
                  placeholder="e.g. Putri Cantika" value="<?= old('nama') ?>">
              ...
              <div class="mb-3 w-100">
                ...
                <input name="alamat" type="text"
                  ...
                  placeholder="e.g. Jalan Daun Hijau Nomor 2" value="<?= old('alamat') ?>">
              ...
              <div class="mb-3 w-100">
                ...
                <input name="no_handphone" type="text"
                  ...
                  placeholder="e.g. 087890901010" value="<?= old('no_handphone') ?>">
            ...
            <div class="card-body">
              <div class="mb-3 w-100">
                ...
                <select name="lokasi_presensi" type="text"
                  ...
                  <option value="<?= $lokasi_option['id'] ?>"
                    <?= old('lokasi_presensi') === $lokasi_option['id'] ? 'selected' : '' ?>>
                    <?= $lokasi_option['nama_lokasi'] ?></option>
                  <?php endforeach; ?>
                  <?php else : ?>
              ...
              <div class="mb-3 w-100">
                ...
                <input name="username" type="text"
                  ...
                  placeholder="e.g. putricantika" value="<?= old('username') ?>">
              ...
              <div class="mb-3 w-100">
                <label class="form-label d-flex align-items-center">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    data-bs-target="#caraAktivasiModal">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="lh-lg mb-4">Aktivasi akun dapat dilakukan di kemudian hari. Admin mengirimkan email aktivasi saat akun
          siap untuk diaktifkan.</p>
        ...
        <p class="lh-lg mb-4">Email aktivasi akan langsung dikirimkan ke alamat email yang diberikan setelah Akun
          berhasil dibuat.</p>
      </div>
