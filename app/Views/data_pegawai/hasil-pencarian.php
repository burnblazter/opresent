      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td><a href="<?= base_url('/data-pegawai/' . $pegawai->username) ?>"
              ...
              <?= $pegawai->nama ?>
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-up-right" width="24"
          ...
          <td>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-x text-danger" width="24"
            ...
            <span class="text-danger">Belum Aktivasi <a
                href="<?= base_url('resend-activate-account?login=' . $pegawai->email) ?>" class="d-block">(Kirim email
                aktivasi)</a></span>
            <?php else : ?>
          ...
          <td class="text-center">
            ...
            <a href="#" class="badge bg-danger btn-hapus" data-id="<?= $pegawai->id ?>"
              data-name="<?= $pegawai->nama ?>" data-bs-toggle="modal" data-bs-target="#modal-danger">
              hapus
            </a>
          </td>
        </tr>
