<?php
// \app\ThirdParty\MythAuth\Authentication\Passwords\NothingPersonalValidator.php
...
class NothingPersonalValidator extends BaseValidator implements ValidatorInterface
{
     ...
     * comes from App\ThirdParty\MythAuth\Entities\User properties username and email.
     *
     ...
     * the `$personalFields` property in App\ThirdParty\MythAuth\Config\Auth, e.g.
     *
     ...
     * Similarity values equal to, or greater than App\ThirdParty\MythAuth\Config::maxSimilarity
