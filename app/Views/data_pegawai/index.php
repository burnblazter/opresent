              ...
              <div class="row">
                <div class="col">
                  <div class="input-icon">
                    ...
                    <input type="text" id="keyword" name="keyword" value="<?= $filter['keyword'] ?>"
                      class="form-control" placeholder="Temukan pegawai berdasarkan nama atau username" autofocus>
                  </div>
                </div>
                <div class="col-auto">
                  <span>
                        ...
                        <div class="row g-1 justify-content-evenly w-100">
                          ...
                          <div class="col-6">
                            ...
                            <select name="role" id="role" class="form-select">
                              ...
                              <option value="<?= $opsi['name'] ?>"
                                <?= ($filter['role'] == $opsi['name']) ? 'selected' : '' ?>><?= $opsi['name'] ?>
                              </option>
                              <?php endforeach; ?>
                            </select>
                          </div>
                        ...
                        <div class="row g-1 justify-content-evenly">
                          <div class="col-6">
                            ...
                            <select name="status" id="status" class="form-select">
                              ...
                              <option value="1" <?= ($filter['status'] == "1") ? 'selected' : '' ?>>Sudah Aktivasi
                              </option>
                              <option value="0" <?= ($filter['status'] == "0") ? 'selected' : '' ?>>Belum Aktivasi
                              </option>
                            </select>
                          </div>
                          <div class="col-6">
                            ...
                            <select name="jenis-kelamin" id="jenis-kelamin" class="form-select">
                              <option value="" <?= ($filter['jenis-kelamin'] == '') ? 'selected' : '' ?>>Tampilkan Semua
                              </option>
                              <option value="Perempuan"
                                <?= ($filter['jenis-kelamin'] == "Perempuan") ? 'selected' : '' ?>>Perempuan</option>
                              <option value="Laki-laki"
                                <?= ($filter['jenis-kelamin'] == "Laki-laki") ? 'selected' : '' ?>>Laki-laki</option>
                            </select>
                          </div>
                        </div>
                      </div>
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-x text-danger"
                      width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                      stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <span class="text-danger">Belum Aktivasi <a
                        href="<?= base_url('resend-activate-account?login=' . $pegawai->email) ?>"
                        class="d-block">(Kirim email aktivasi)</a></span>
                    <?php else : ?>
                    <svg xmlns="http://www.w3.org/2000/svg"
                      class="icon icon-tabler icon-tabler-circle-check text-success" width="24" height="24"
                      viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
                      stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                      <path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" />
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center py-4">
        ...
        <h3>Hapus?</h3>
        <div class="text-muted">Apakah Anda yakin ingin menghapus data pegawai <strong><span id="modal-name"
              class="text-danger">ini</span></strong>? Data pegawai yang sudah dihapus tidak dapat dikembalikan.</div>
      </div>
            ...
            <div class="row g-1 justify-content-evenly w-100">
              <div class="col-6">
                ...
                <select name="jabatan" id="jabatan" class="form-select">
                  ...
                  <?php foreach ($data_jabatan as $opsi) : ?>
                  <option value="<?= $opsi['jabatan'] ?>"
                    <?= ($filter['jabatan'] == $opsi['jabatan']) ? 'selected' : '' ?>><?= $opsi['jabatan'] ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
              <div class="col-6">
...
$(document).ready(function() {
  $('#keyword').on('keyup', function() {
    $.get('cari-pegawai?keyword=' + $('#keyword').val() + '&jabatan=' + $('#jabatan').val() + '&role=' + $(
        '#role').val() + '&status=' + $('#status').val() + '&lokasi-presensi=' + $('#lokasi-presensi').val() +
      '&jenis-kelamin=' + $('#jenis-kelamin').val(),
      function(data) {
      ...
      <form action="<?= base_url('/data-pegawai/import-excel') ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <small class="form-hint">Format: .xlsx atau .xls</small>
          </div>
          <div class="alert alert-info">
            <h4 class="alert-title">Panduan Import:</h4>
            <ul class="mb-0">
          ...
          <div class="modal-footer">
            <a href="<?= base_url('/data-pegawai/download-template') ?>" class="btn btn-primary">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
